...
function miout=helper_MIhigherdim(x,env,kneig,emb_dim,emb_tau)
...
switch env
    case 'doerlbh'
%         disp(['MIhigherdim zwspMIhigh.txt ',num2str(Nd),' ',num2str(emb_dim),' ',num2str(emb_tau),' ',num2str(N),' ',num2str(kneig)]);
        [a, unout]=unix(['./MIhigherdim zwspMIhigh.txt ',num2str(Nd),' ',num2str(emb_dim),' ',num2str(emb_tau),' ',num2str(N),' ',num2str(kneig)]);
        miout = str2num(unout);
    otherwise
%         disp(['MIhigherdim_bnb zwspMIhigh.txt ',num2str(Nd),' ',num2str(emb_dim),' ',num2str(emb_tau),' ',num2str(N),' ',num2str(kneig)]);
        [a, unout]=unix(['./MIhigherdim_bnb zwspMIhigh.txt ',num2str(Nd),' ',num2str(emb_dim),' ',num2str(emb_tau),' ',num2str(N),' ',num2str(kneig)]);
        miout = str2num(unout);
end
