...
function [dCorMapThreshsInf, dCorMapThreshs] = helper_pfindDCorMapThreshs(X, Y, Xthreshs, Ythreshs, nSearchRandomisations, method)
            ...
            for lYThreshI=1:uYThreshI-1
                ...
                parfor randomisationI=1:nSearchRandomisations
                    dCorMapThreshs_rnd(randomisationI) = ...
                        helper_pdCorLU(X,Y(randperm(nObs),:),lXThresh,uXThresh,lYThresh,uYThresh,method);
                end
