function [optimals, stats, statnames] = helper_r_evaluate_statistics_rest(xs,ys,nRandomisations,env)
...
% [optimals.ADGTIC1dCorMax, optimals.ADGTIC1dCorInfMax, optimals.ADGTIC1nndCorInfMax, stats(8), stats(9), stats(10)] = statistic_rADGTIC1(xs,ys,nThreshs,nNormRandomisations,nSearchRandomisations);
...
% [optimals.ADGTIC2dCorMax, optimals.ADGTIC2dCorInfMax, optimals.ADGTIC2nndCorInfMax, stats(11), stats(12), stats(13)] = statistic_rADGTIC2(xs,ys,nThreshs,nNormRandomisations,nSearchRandomisations);
...
% [optimals.ADGTIC3dCorMax, optimals.ADGTIC3dCorInfMax, optimals.ADGTIC3nndCorInfMax, stats(14), stats(15), stats(16)] = statistic_rADGTIC3(xs,ys,nThreshs,nNormRandomisations,nSearchRandomisations);
% disp(['ADGTIC3 ' num2str(stats(14)) ' ' num2str(stats(15)) ' ' num2str(stats(16))])
% 
% % ADsnpIC
% statnames{17} = 'ADIC - snpInf';
% [optimals.ADsnpIC, stats(17)] = statistic_rADsnpIC(xs,ys,nThreshs,nRandomisations);
% disp(['ADsnpIC ' num2str(stats(17))])
% 
% % ADdsnpIC
% statnames{18} = 'ADIC - dsnpInf';
% [optimals.ADdsnpIC, stats(18)] = statistic_rADdsnpIC(xs,ys,nThreshs,nRandomisations);
...
mxFwhmFac=0.5;
% statnames{20} = 'AKIC';
% [optimals.AKIC, stats(20)] = statistic_rAKIC(xs,ys,nKernelWidths,mxFwhmFac);
...
[optimals.mikMax,optimals.mikInfMax, stats(23), stats(24)] = statistic_rAmi_kraskov(xs(:),ys(:),env,nNormRandomisations);
...
[optimals.pADGTIC1dCorMax, optimals.pADGTIC1dCorInfMax, optimals.pADGTIC1nndCorInfMax, stats(25), stats(26), stats(27)] = statistic_rpADGTIC1(xs,ys,nThreshs,nNormRandomisations,nSearchRandomisations);
...
[optimals.pADGTIC2dCorMax, optimals.pADGTIC2dCorInfMax, optimals.pADGTIC2nndCorInfMax, stats(28), stats(29), stats(30)] = statistic_rpADGTIC2(xs,ys,nThreshs,nNormRandomisations,nSearchRandomisations);
