function [optimals, stats, statnames] = helper_r_fine_evaluate_statistics(xs,ys,nRandomisations,env)
...
[optimals.mikMax,optimals.mikInfMax, stats(23), stats(24)] = statistic_rAmi_kraskov(xs(:),ys(:),env,nRandomisations);
