...
function run_power_fpr(loc,type)
...
switch type
    case 'l',
        ...
        for n = 1:upperObs
            ...
            parfor run_num = 1:nRandomisations
                ...
                [pos_stats(:,run_num), ~] = helper_evaluate_statistics(xs,ys,nRandomisations,loc);
                [null_stats(:,run_num), ~] = helper_evaluate_statistics(xs,ys(randperm(N)),nRandomisations,loc);
        ...
        save results/power_fdr/linear_power_fpr.mat l_pos_stats l_null_stats l_power l_dpower
    ...
    case 'p',
        ...
        save results/power_fdr/parabolic_power_fpr.mat p_pos_stats p_null_stats p_power p_dpower
    ...
    case 's',
        ...
        save results/power_fdr/sinusoidal_power_fpr.mat s_pos_stats s_null_stats s_power s_dpower
    ...
    case 'c',
        ...
        save results/power_fdr/circular_power_fpr.mat c_pos_stats c_null_stats c_power c_dpower
    ...
    case 'k',
        ...
        save results/power_fdr/checkerboard_power_fpr.mat k_pos_stats k_null_stats k_power k_dpower
