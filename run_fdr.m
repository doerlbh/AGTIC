...
switch type
    case 'l',
        ...
        for n = 1:upperObs
            ...
            [pos_stats, stat_names] = helper_evaluate_statistics(xs,ys,nRandomisations,loc);
            
            parfor run_num = 1:nRandomisations
                
                disp(['__linear obs ' num2str(N) ' run ' num2str(run_num)])
                [null_stats(:,run_num), null_stat_names] = helper_evaluate_statistics(xs,ys(randperm(N)),nRandomisations,loc);
