...
function run_noise_opts_p(loc, Q, num_trials,nRandomisations,start)
...
save new_results/power_fdr/opts_computations.mat computations relationships noises
...
for run_num = start:num_runs
    ...
    for m=1:num_trials
        ...
        [null_optimals, null_stats(:,m), ~] = helper_r_fine_evaluate_statistics(xs,ys_null,nRandomisations,loc);
    ...
    save(['new_results/power_fdr/opts_results_' num2str(run_num) '.mat'], 'results')
