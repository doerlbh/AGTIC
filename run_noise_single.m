...
function run_noise_single(loc, Q, num_trials,nRandomisations, relation)
...
for run_num = 1:num_runs
    ...
    for m=1:num_trials
        ...
        [pos_optimals, pos_stats(:,m), ~] = helper_r_evaluate_statistics(xs,ys,nRandomisations,loc);
        ...
        [null_optimals, null_stats(:,m), ~] = helper_r_evaluate_statistics(xs,ys_null,nRandomisations,loc);
    ...
    save(['new_results/power_fdr/l_results_' num2str(run_num) '.mat'], 'results')
